...
context("get_pc_set_norm_form")

test_that("examples", {
  expect_equal(
    get_pc_set_norm_form(c(0, 4, 7)) %>% as.integer,
    c(0, 4, 7)
  )
  expect_equal(
    get_pc_set_norm_form(c(3, 6, 7, 10)) %>% as.integer,
    c(0, 3, 4, 7)
  )
  expect_equal(
    get_pc_set_norm_form(c(0, 3, 6, 7, 8, 10)) %>% as.integer,
    c(0, 1, 2, 4, 6, 9)
  )
  expect_equal(
