...
test_that("examples", {
  expect_equal(
    hutil::normalise_bass(hutil::pc_chord(4, c(7, 11))),
    hutil::pc_chord(0, c(3, 7))
  )
  expect_equal(
    hutil::normalise_bass(hutil::pc_chord(10, c(4, 7))),
    hutil::pc_chord(0, c(6, 9))
  )
})

test_that("application to compositions", {
  c1 <- hutil::pc_chord(3, c(4, 5))
  c2 <- hutil::pc_chord(5, c(7, 9))
  c3 <- hutil::pc_chord(1, c(5, 8))
  c4 <- hutil::pc_chord(2, c(5, 9))
  expect_equal(
